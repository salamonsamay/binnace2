...
public final class GetOrder {
    ...
    public static void main(String[] args) {
        ...
        SpotClient client = new SpotClientImpl(PrivateConfig.API_KEY, PrivateConfig.SECRET_KEY, PrivateConfig.BASE_URL);

        parameters.put("symbol", "SLPUSDT");
        parameters.put("orderId", "440138153");
